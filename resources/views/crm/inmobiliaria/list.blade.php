...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Inmobiliarias</h2>
            <ul class="header-dropdown">
                <li>
                    <a href="{{route('inmobiliarias.create')}}" data-toggle="tooltip" data-original-title="Create">
        ...
        <div class="body">
            <table id="inmobiliarias_table" class="table table-bordered table-striped table-hover dataTable js-exportable" style="width: 100%;">
                <thead>
                <tr>
                    <th>
