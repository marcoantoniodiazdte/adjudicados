...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Equipo</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        <a href="{{route('equipos.create')}}" data-toggle="tooltip" data-original-title="Create">
        ...
        <div class="body">
           ...
           <table id="equipos_table" class="table table-bordered table-striped table-hover dataTable js-exportable" style="width: 100%;">
                <thead>
                <tr>
...
@section('pages_js_files')
    ...
    <script>
        if($('#equipos_table').size() > 0){
    
        $('#equipos_table').DataTable(
                ...
                columns: [
                    ...
                    { data: 'precio', name: 'precio' },
                    {
                        data: function (data) {
                            ...
                            // if (data.view === true) {
                            //     buttons += '<a href="/admin/equipos/' + data.id + '" target="_blank" class="btn btn-info btn-xs waves-effect" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/equipos/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
