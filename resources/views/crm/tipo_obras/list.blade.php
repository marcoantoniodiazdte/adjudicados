...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i>Tipo de Obras</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        <a href="{{route('tipoObras.create')}}" data-toggle="tooltip" data-original-title="Create">
                ...
                columns: [
                    ...
                    { data: 'descripcion', name: 'descripcion' },
                    {
                        data: function (data) {
                            ...
                            // if (data.view === true) {
                            //     buttons += '<a href="/admin/tipoObras/' + data.id + '" target="_blank" class="btn btn-info btn-xs waves-effect" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/tipoObras/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
