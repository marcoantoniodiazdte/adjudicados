...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Create Agencia</h2>
       </div>
       <div>
           <div class="body">
               <div id="validation-errors" class="alert alert-danger" style="display:none"></div>

               <form method="POST" id="agencia_new_form" action="{{ route('agencias.store') }}">
                           ...
                           <div class="row ">
                               <select id="modulos" name="modulos[]" class="ms validate" multiple="multiple">
                                   @foreach($modulos as $modulo)
                                       <option value="{{ $modulo->id }}">{{ $modulo->title }} <span class="small font-6"> [{{ $modulo->description }}]</span></option>
               ...
               <div class="row" id="loanding_agencia_new_form" style="display: none;">
