...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Editar Requisitos</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => ['requisitos.update', 'id' => $requisito->id], 'method' => 'post' , 'id' => 'inmueble_form','enctype' => 'multipart/form-data']) !!}
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="col-lg-4">
                       <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$requisito->nombre}}" name="nombre" required >
                    ...
                    <div class="col-lg-8">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$requisito->descripcion}}" name="telefono" required >
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <select class="btn-group bootstrap-select form-control show-tick" data-live-search="true" name="categoria_id" id="">
                                    @foreach($categorias as $categoria)
                                        {{-- {{var_dump($categoria)}} --}}
                                        <option value="{{$categoria->id}}" {{($requisito->categoria_id == $categoria->id ? 'selected': '')}}>{{$categoria->nombre}}</option>
                                    @endforeach
                                </select>
