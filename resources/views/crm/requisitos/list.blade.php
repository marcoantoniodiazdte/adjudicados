...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Requisitos</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        <a href="{{route('requisitos.create')}}" data-toggle="tooltip" data-original-title="Crear">
        ...
        <div class="body">
           ...
           <table id="inmo_table" class="table table-bordered table-striped table-hover dataTable js-exportable" style="width: 100%;">
                ...
                <tr>
                    ...
                    <th class="exportar">Categoría</th>
                    <th>Opciones</th>
                </tr>
                </thead>
                ...
                columns: [
                    ...
                    { data: 'categoria.nombre', name: 'categoria.nombre' },
                    {
                        data: function (data) {
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/requisitos/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
