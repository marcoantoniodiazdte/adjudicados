...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Vehiculos</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        <a href="{{route('vehiculos.create')}}" data-toggle="tooltip" data-original-title="Crear">
        ...
        <div class="body">
           ...
           <table id="vehiculos_table" class="table table-bordered table-striped table-hover dataTable js-exportable" style="width: 100%;">
                <thead>
                <tr>
                    ...
                    <th class="exportar">Código Referencia</th>
                    <th>Opciones</th>
                ...
                columns: [
                    ...
                    { data: 'codigo_referencia', name: 'codigo_referencia' },
                    {
                        data: function (data) {
                            ...
                            // if (data.view === true) {
                            //     buttons += '<a href="/admin/vehiculos/' + data.id + '" target="_blank" class="btn btn-info btn-xs waves-effect" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/vehiculos/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a id="'+ data.id +'" target="_blank" class="btn btn-danger btn-xs waves-effect delete" ' +
