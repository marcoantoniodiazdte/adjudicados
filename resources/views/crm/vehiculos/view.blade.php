...
<div class="content-area properties-details-page">
    <div class="">
        <div class="carousel" data-flickity='{ "fullscreen": true, "lazyLoad": 1, "initialIndex":1}'>
            @foreach($vehiculo->archivos as $archivo)
                <img class="carousel-image" data-flickity-lazyload="/vehiculo/abrirImagen/{{$archivo->id}}" />
            @endforeach
        </div>
    </div>
    <div class="container">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="heading-properties clearfix sidebar-widget">
                    ...
                    <div class="pull-left" style="margin-left: 20px;">
                        <span>Estado:</span>
                        <p>
                        <label class="label label-default">{{strtoupper($vehiculo->titulo)}}</label>
                        </p>
                    </div>
