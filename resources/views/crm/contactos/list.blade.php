...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Contactos</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        <a href="{{route('contactos.create')}}" data-toggle="tooltip" data-original-title="Crear">
                ...
                columns: [
                    ...
                    { data: 'correo', name: 'correo' },
                    {
                        data: function (data) {
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/contactos/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
