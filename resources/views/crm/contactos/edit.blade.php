...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Editar Contacto</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => ['contactos.update', 'id' => $contacto->id], 'method' => 'post' , 'id' => 'inmueble_form','enctype' => 'multipart/form-data']) !!}
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="col-lg-4">
                       <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$contacto->nombre}}" name="nombre" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$contacto->telefono}}" name="telefono" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$contacto->celular}}" name="celular"  >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$contacto->correo}}" name="correo"  >
                            ...
                            <div class="form-line focused">
                                <select class="btn-group bootstrap-select form-control show-tick" required data-live-search="true" name="inmobiliaria_id" >
                                    @foreach($inmobiliarias as $inmobiliaria)
                                        <option value="{{$inmobiliaria->id}}" {{($contacto->inmobiliaria_id == $inmobiliaria->id ? 'selected': '' )}} >{{$inmobiliaria->nombre}}</option>
                                    @endforeach
                                </select>
