...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Tipo de Propiedades</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => ['tipoPropiedades.update',$propiedad->id], 'method' => 'post' ,'enctype' => 'multipart/form-data']) !!}
               @csrf
               <div class="row">
                   <div class="col-lg-6">
                       <div class="form-group form-float">
                            <div class="form-line focused">
                            <input type="text" class="form-control validate" value="{{$propiedad->name}}" required name="name" required >
