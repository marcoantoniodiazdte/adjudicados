...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Editar Tipo de Equipos</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => ['tipoEquipos.update', $tipo->id] ,'enctype' => 'multipart/form-data']) !!}
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="col-lg-4">
                       <div class="form-group form-float">
                            ...
                            <input type="text" class="form-control validate" value="{{$tipo->nombre}}" required name="nombre" required >
                    ...
                    <div class="col-lg-8">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$tipo->descripcion}}" required name="descripcion" required >
