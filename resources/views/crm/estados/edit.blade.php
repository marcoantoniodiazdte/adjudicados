...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Editar Estado Oportunidades</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => ['estados.update', 'id' => $estado->id], 'method' => 'post' , 'id' => 'inmueble_form','enctype' => 'multipart/form-data']) !!}
               @csrf
               @method('PUT')
               <div class="row">
                   <div class="col-lg-4">
                       <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$estado->nombre}}" {{($estado->sistema) ? 'disabled': ''}} name="nombre" required >
                    ...
                    <div class="col-lg-8">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$estado->descripcion}}" {{($estado->sistema) ? 'disabled': ''}} name="telefono" required >
                    ...
                    <div class="col-sm-8 col-md-2">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                    ...
                                    <p><input type="color" name="color_letra" id="color_letra"  class="form-control" value="{{$estado->color_letra}}"  /></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-8 col-md-2">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                    ...
                                    <p><input type="color" name="color" id="color"  class="form-control" value="{{$estado->color}}" /></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-2 col-lg-2">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <select class="btn-group bootstrap-select form-control show-tick" required data-live-search="true" name="notificacion" id="clase">
                                        <option value="1" {{($estado->notificacion == "1" ? 'selected' : '')}}>Si</option>
                                        <option value="0" {{($estado->notificacion == "0" ? 'selected' : '')}} >No</option>
                                </select>
                                <label class="form-label m-t--5">Correo de Notificación</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" value="{{$estado->mensaje}}" name="mensaje"  >
