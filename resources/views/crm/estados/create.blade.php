...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Crear Estado Oportunidades</h2>
       </div>
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => 'estados.store', 'method' => 'post' , 'id' => 'inmueble_form','enctype' => 'multipart/form-data']) !!}
               @csrf
               <div class="row">
                   <div class="col-lg-4">
                    ...
                    <div class="col-sm-8 col-md-2">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                    ...
                                    <p><input type="color" name="color_letra" id="color_letra"  class="form-control" value="#ffffff" /></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-8 col-md-2">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                    ...
                                    <p><input type="color" name="color" id="color"  class="form-control" value="#ffffff" /></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control validate" name="mensaje"  >
