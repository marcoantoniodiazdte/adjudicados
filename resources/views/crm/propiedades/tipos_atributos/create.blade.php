...
@section('contenido_inmobiliaria')
   <div class="card">
       <div class="header">
           <h2><i class="material-icons">add</i>Crear Tipo Atributo</h2>
       </div>
       ...
       <div class="body">
           <div class="row">
               ...
               {!! Form::open(['route' => 'tipos_atributos.store', 'method' => 'post']) !!}
                   ...
                   <div class="col-sm-8 col-md-12">
                       <div class="form-group form-float m-b-0">
                           <div class="form-line">
                               <input type="text" class="form-control" name="icono"  maxlength="100" />
                   ...
                   <div class="col-xs-12 align-center">
                       <button type="submit" class="btn btn-primary m-t-15 waves-effect">Crear Tipo Atributo</button>
                   </div>
