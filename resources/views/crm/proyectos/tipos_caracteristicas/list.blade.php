...
@section('title','Tipos Caracteristicas')
...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            ...
            <ul class="header-dropdown">
                @can('create.tipos_caracteristicas')
                    <li>
                        <a href="{{route('tipos_caracteristicas.create')}}" data-toggle="tooltip" data-original-title="Crear">
        ...
        <div class="body">
            <div class="body">
                <table id="tipos_caracteristicas_table" class="table table-bordered table-striped table-hover dataTable js-exportable" style="width: 100%;">
                    <thead>
                    <tr>
                        <th>
