...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Obras</h2>
                ...
                columns: [
                    ...
                    { data: 'codigo_referencia', name: 'codigo_referencia' },
                    {
                        data: function (data) {
                            ...
                            // if (data.view === true) {
                            //     buttons += '<a href="/admin/obras/' + data.id + '" target="_blank" class="btn btn-info btn-xs waves-effect" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/obras/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
