...
@section('contenido_inmobiliaria')
   <div class="card">
       ...
       <div class="body">
               ...
               {!! Form::open(['route' => 'obras.update', 'method' => 'post' ,'enctype' => 'multipart/form-data']) !!}
               @csrf
               <div class="row">
                   <div class="col-lg-4">
                   ...
                   <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio}}" required name="precio" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio}}" required name="precio_usd" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio}}" required name="precio_eu">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio_oferta}}" required name="precio_oferta" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio_oferta_usd}}" required name="precio_oferta_usd" required >
                    ...
                    <div class="col-lg-4">
                        <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="number" class="form-control validate" value="{{$obra->precio_oferta_eu}}" required name="precio_oferta_eu" required >
