...
@section('contenido_inmobiliaria')
    <div class="card">
        <div class="header">
            <h2><i class="material-icons">list</i> Categorias</h2>
            <ul class="header-dropdown">
                @can('create.propiedades')
                    <li>
                        {{-- <a href="{{route('categorias.create')}}" data-toggle="tooltip" data-original-title="Crear">
                ...
                columns: [
                    ...
                    { data: 'nombre', name: 'nombre' },
                    {
                        data: function (data) {
                            ...
                            // if (data.edit === true) {
                            //     buttons +=
                            //         '<a href="/admin/categorias/' + data.id + '/edit" target="_blank" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
