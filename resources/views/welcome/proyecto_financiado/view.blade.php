    ...
    <div class="">
        <div class="carousel" data-flickity='{ "fullscreen": true, "lazyLoad": 1, "initialIndex":1}'>
            @foreach($propiedad->archivos as $archivo)
                <img class="carousel-image" data-flickity-lazyload="/proyecto/abrirImagen/{{$archivo->id}}" />
            @endforeach
        </div>
    </div>
    <div class="container">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="heading-properties clearfix sidebar-widget">
                    ...
                    <div class="pull-left" style="margin-left: 20px;">
                        <span>Estado:</span>
                        <p>
                        <label class="label label-default {{$propiedad->estado}}">{{strtoupper($propiedad->estado)}}</label>
                        </p>
                    </div>
                ...
                <div class="sidebar right">
                    <div class="sidebar-widget helping-box clearfix">
                        ...
                        <div class="helping-center">
                            ...
                            <h4>Inmobiliaria</h4>
                            <span>{{$propiedad->inmobiliaria->nombre}}</span>
                        </div>
                        <div class="helping-center">
                            ...
                            <div class="media-body">
                                ...
                                <div class="">
                                    <p class="price" usd="{{$prop->precio_oferta_usd}}"  dop="{{$prop->precio_oferta_rd}}" eur="{{$prop->precio_oferta_eu}}">
                                        {{$prop->oferta}}$ {{number_format($prop->monto, 2)}}
                                    </p>
                                </div>
                            </div>
                        </div>
