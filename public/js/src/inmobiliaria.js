        ...
        $('#inmobiliarias_table').DataTable(
            $.extend(true, {}, $.InmobiliariaSoft.options.DATATABLE_TEMPLATE,{
                ...
                columns: [
                    ...
                    { data: 'telefono_company', name: 'telefono_company' },
                    { data: 'correo_company', name: 'correo_company' },
                    {
                        data: function (data) {
                            var buttons = '<div class="btn-group">';

                            if (data.view === true) {
                                buttons += '<a href="/admin/inmobiliarias/' + data.id + '" target="_self" class="btn btn-info btn-xs waves-effect" ' +
                            ...
                            if (data.edit === true) {
                                buttons +=
                                    '<a href="/admin/inmobiliarias/' + data.id + '/edit" target="_self" class="btn btn-warning btn-xs waves-effect edit-brand" ' +
